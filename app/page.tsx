...
const features = [
  {
    ...
    description:
      "Paste any long link and instantly generate clean short URLs ready to share.",
  },
  {
    title: "Team and security",
    description:
      "Secure sign-in with Clerk and smooth collaboration for your whole team.",
  },
];
      ...
      <section className="mx-auto w-full max-w-5xl rounded-2xl border bg-card/60 p-8 shadow-sm backdrop-blur md:p-12">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h1 className="mt-5 text-4xl font-semibold tracking-tight md:text-6xl">
            Shorten links and scale campaigns with LinkShortApp
          </h1>
          <p className="mt-5 text-lg text-muted-foreground">
            Create short URLs for social media, newsletters, and ads. Everything
            in one dashboard, with secure sign-in and fast access for your team.
          </p>
        ...
        <ul className="mt-10 grid gap-4 sm:grid-cols-3">
          {highlights.map((item) => (
            <li
              key={item.label}
              className="rounded-xl border bg-background/50 p-4 text-center"
            >
