			...
			<Dialog open={isEditOpen} onOpenChange={onEditDialogOpenChange}>
				...
				<DialogContent>
					<DialogHeader>
						...
						<DialogDescription>Zmień adres docelowy lub kod skrótu dla tego linku.</DialogDescription>
					</DialogHeader>
			...
			<Dialog open={isDeleteOpen} onOpenChange={onDeleteDialogOpenChange}>
				...
				<DialogContent>
					<DialogHeader>
						...
						<DialogDescription>Tej operacji nie można cofnąć. Link /{shortCode} zostanie trwale usunięty.</DialogDescription>
					</DialogHeader>
